...
namespace KolmGG
{
    ...
    {
        Label time, timeLabel1, plusLeftLabel1, plusRightLabel1, minusLeftLabel, minusRightLabel, multLeftLabel, multRightLabel, subLeftLabel, subRightLabel;
        ...
        private void Second_Load_1(object sender, EventArgs e)
        {
